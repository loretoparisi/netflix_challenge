...
predictor started doing worse), 30 time bins, and a learning rate decay of
0.940. All other parameters were the same as those in TIMESVDPP_QUAL_7.749.


TIMESVDPP_QUAL_6.814: This was generated on May 24 at 6:17 am. Time-SVD++
was carried out on the entire dataset **except probe** and **without
userFacMatTime**. This run involved 750 factors, 80 iterations, and 30 time
bins, as well as a learning rate decay of 0.940. The remaining parameters
...
factors, 25 iterations, and 30 time bins. All other parameters, including
the learning rate decay, were the same as those in TIMESVDPP_QUAL_7.749.


TIMESVDPP_QUAL_7.759: This was generated on May 22 at 4:47 am. Time-SVD++
was run on the entire dataset **without userFacMatTime**, and with 750
factors, 80 iterations, 30 time bins, and a learning rate decay of 0.935.
...
TIMESVDPP_QUAL_7.793: This was generated on May 21 at 2:21 pm. Time-SVD++
was run on the entire dataset **without userFacMatTime**, and with 1000
factors, 80 iterations, 30 time bins, and a learning rate decay of 0.935.
All other parameters (LRs/RFs) were the same as those in
TIMESVDPP_QUAL_7.749.


TIMESVDPP_QUAL_6.913: This was generated on May 21 at 6:30 am. Time-SVD++
was run on the entire dataset with 150 factors, 80 iterations, 30 time
bins, with userFacMatTime included, and with a learning rate decay of
0.945. All other parameters (LRs/RFs) were the same as those in
TIMESVDPP_QUAL_7.749.
...
didn't contribute very well to the blend.


TIMESVDPP_QUAL_6.857: This was generated on May 16 at 3:59 am. Time-SVD++
was carried out on the entire dataset with 60 factors, 80 iterations, and a
learning rate decay of 0.945. All other LRs/RFs were the same as those in
TIMESVDPP_QUAL_7.749. Note that the predictions generated by this run were
*not* bounded, since this run was preprocessed by kNN (which actually
brought down the QRMSE).
...
KNN_ON_RBM_QUAL_3.665: This was generated on May 21 around 3 am.  KNN was
run on RBM, which was run on the entire dataset with 400 factors and 120
iterations. The remaining parameters used were:
    * alpha = 0.001
    * beta = 0.002
...
RBM_QUAL_4.116: This was generated on May 22. RBM was run on all with 400
factors and 120 iterations. The parameters were the same as those in
RBM_QUAL_4.597.

RBM_QUAL_3.315: This was generated on May 21. RBM was run on all with 30
factors and 120 iterations. The parameters were the same as those in
RBM_QUAL_4.597.

RBM_QUAL_4.186: This was generated on May 21. RBM was run on all with 50
factors and 120 iterations. The parameters were the same as those in
RBM_QUAL_4.597.

RBM_QUAL_4.597: This was generated on May 21. RBM was run on all with 300
factors and 120 iterations. The following parameters were used:
    * rbm_alpha = 0.001
    * rbm_beta = 0.002
    * dec = 0.002
